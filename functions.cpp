...
/////////////////////////////////////////////////////////////////
/*
calling by ref , most used method
...
/*
calling by pointer , used when dealing with dynamic memory allocation
befor using it , you should make a pointer of the var
*/
void fun_pointer(int * pointer)
{
...
{ // this is called function overloading to make the same function valid for many types of inputs
	float sum = a + b + c;
	cout << sum << endl;
}

int factorial(int n)
{ // this is call recursion : making a function recall itself (figures for recursion and memory in c++)
	if (n == 1)
	{ // the exit condition (base case) important in recursion
		return 1;
	}
